...
TEAM_ACRONYMS = {
    ...
    # NCAAF (select teams)
    'ALABAMA CRIMSON TIDE': 'BAMA', 'ALABAMA': 'BAMA', 'CRIMSON TIDE': 'BAMA', 'BAMA': 'BAMA',
    'CLEMSON TIGERS': 'CLEM', 'CLEMSON': 'CLEM', 'TIGERS': 'CLEM', 'CLEM': 'CLEM',
    'GEORGIA BULLDOGS': 'UGA', 'GEORGIA': 'UGA', 'BULLDOGS': 'UGA', 'DAWGS': 'UGA', 'UGA': 'UGA',
    'OHIO STATE BUCKEYES': 'OSU', 'OHIO STATE': 'OSU', 'BUCKEYES': 'OSU', 'OSU': 'OSU',
    'MICHIGAN WOLVERINES': 'MICH', 'MICHIGAN': 'MICH', 'WOLVERINES': 'MICH', 'MICH': 'MICH',
    'NOTRE DAME FIGHTING IRISH': 'ND', 'NOTRE DAME': 'ND', 'FIGHTING IRISH': 'ND', 'ND': 'ND',
    'OKLAHOMA SOONERS': 'OU', 'OKLAHOMA': 'OU', 'SOONERS': 'OU', 'OU': 'OU',
    'TEXAS LONGHORNS': 'TEX', 'TEXAS': 'TEX', 'LONGHORNS': 'TEX', 'HOOKEM': 'TEX', 'TEX': 'TEX',
    'USC TROJANS': 'USC', 'SOUTHERN CALIFORNIA': 'USC', 'TROJANS': 'USC', 'USC': 'USC',
    'LSU TIGERS': 'LSU', 'LOUISIANA STATE': 'LSU', 'TIGERS': 'LSU', 'LSU': 'LSU',
}
